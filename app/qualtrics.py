...
def exportSurvey(apiToken,surveyId, dataCenter, fileFormat):
    ...
    try:
        ...
        print(f"[ERROR] Unknown error occurred during Qualtrics request: {err}")
        return None
    else:
        print("[INFO] Qualtrics request response received")
        if downloadRequestResponse:
            print(f"[INFO] Qualtrics response successful - Status code: {downloadRequestResponse.status_code}")
        else:
            print(f"[ERROR] Qualtrics response unsuccessful - Status code: {downloadRequestResponse.status_code}")
            return None
    ...
    try:
        ...
        print(f"[ERROR] Error during Qualtrics data export: {err}")
        return None
    ...
    try:
        ...
        print(f"[ERROR] Error during downloading Qualtrics survey file: {err}")
        return None
    ...
    try:
        ...
        print(f"[ERROR] Error when unzipping Qualtrics survey file: {err}")
        return None
